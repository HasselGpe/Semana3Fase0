...
# Cuando definimos una clase podemos necesitar estados y comportamientos. Los estados son datos, 
# variables, propiedades, atributos (ej. nombre, modelo o marca) o constantes. 
# Los comportamientos (métodos) se refieren a las acciones que son capaces de hacer los objetos 
# (acelerar, frenar, etc.).
...
# El método initialize sirve para arrancar o construir cada objeto que la clase crea.
# Puede recibir parámetros que estarán relacionados al comportamiento o estados de la clase.
# #############################################################################################
# Variables de Instancia y Métodos de Instancia

# Tomando como ejemplo la clase RaceCar del ejemplo anterior, vamos a crear dos objetos RaceCar: 
# uno llamado "speedy" y otro "bolt". Los dos son objetos RaceCar, sin embargo pueden contener 
# información diferente como brand y model.
...
# Estos comportamientos se llaman métodos de instancia en una clase. 
# Los métodos de instancia definidos en una clase pueden ser utilizados por objetos o 
...
bolt.frenar
 ...
 # En resumen, las variables de instancia permiten hacer un seguimiento del estado y los 
 # métodos de instancia muestran el comportamiento de los objetos.
# #############################################################################################
# Métodos de Clase
...
# Los métodos de clase no pueden ser llamados por la instancia. Sólo pueden ser 
# llamados usando la clase donde fueron definidos.
# #############################################################################################
class RaceCar
  def initialize(brand, model)
    #variable de instancia 1
...
RaceCar.incrementar_velocidad == "Incrementando velocidad"
# #############################################################################################
# Variables de clase
